...
ifeq ($(BR2_TARGET_NXP_QORIQ_DDR_FW),y)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += DDR_PHY_BIN_PATH=$(NXP_QORIQ_DDR_FW_DIR)/lx2160a
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += nxp-qoriq-ddr-fw
endif
